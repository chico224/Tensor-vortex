...
flowchart TD
    %% Entrées
    subgraph Market Data [Flux du Marché MT5]
    ...
    %% Moteur d'Analyse
    subgraph Quant Engine [Raisonnement Parallèle (110 Experts)]
    ...
    %% Exécution et Survie
    subgraph Execution & Survival [Validation & Exécution Broker]
